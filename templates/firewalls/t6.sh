...
verify_interfaces() {
    :
    echo "Verifying interfaces: lo end0 end1"
    for i in lo end0 end1 ; do
...
configure_interfaces() {
    ...
    getaddr end0  i_end0
    getaddr6 end0  i_end0_v6
    getnet end0  i_end0_network
    getnet6 end0  i_end0_v6_network
    getaddr end1  i_end1
    getaddr6 end1  i_end1_v6
    getnet end1  i_end1_network
    getnet6 end1  i_end1_v6_network
}
...
script_body() {
    ...
    do
    test -n "$i_end1" && $IPTABLES -A INPUT -i end0   -s $i_end1   -j In_RULE_0 
    done
    for i_end0 in $i_end0_list
    do
    test -n "$i_end0" && $IPTABLES -A INPUT -i end0   -s $i_end0   -j In_RULE_0 
    done
    for i_end1 in $i_end1_list
    do
    test -n "$i_end1" && $IPTABLES -A INPUT -i end1   -s $i_end1   -j In_RULE_0 
    done
    for i_end0 in $i_end0_list
    do
    test -n "$i_end0" && $IPTABLES -A INPUT -i end1   -s $i_end0   -j In_RULE_0 
    done
    for i_end1 in $i_end1_list
    do
    test -n "$i_end1" && $IPTABLES -A FORWARD -i end0   -s $i_end1   -j In_RULE_0 
    done
    for i_end0 in $i_end0_list
    do
    test -n "$i_end0" && $IPTABLES -A FORWARD -i end0   -s $i_end0   -j In_RULE_0 
    done
    for i_end1 in $i_end1_list
    do
    test -n "$i_end1" && $IPTABLES -A FORWARD -i end1   -s $i_end1   -j In_RULE_0 
    done
    for i_end0 in $i_end0_list
    do
    test -n "$i_end0" && $IPTABLES -A FORWARD -i end1   -s $i_end0   -j In_RULE_0 
    done
    ...
    $IPTABLES -A OUTPUT -p tcp -m tcp  -s 127.0.0.1   -d 127.0.0.1   --dport 2049  -m state --state NEW  -j ACCEPT
    $IPTABLES -A OUTPUT -p udp -m udp  -s 127.0.0.1   -d 127.0.0.1   --dport 2049  -m state --state NEW  -j ACCEPT
    $IPTABLES -A OUTPUT -p tcp -m tcp  -d 192.168.2.159   --dport 2049  -m state --state NEW  -j ACCEPT
    $IPTABLES -A OUTPUT -p udp -m udp  -d 192.168.2.159   --dport 2049  -m state --state NEW  -j ACCEPT
    $IPTABLES -A INPUT -p tcp -m tcp  -s 192.168.2.159   --dport 2049  -m state --state NEW  -j ACCEPT
    $IPTABLES -A INPUT -p udp -m udp  -s 192.168.2.159   --dport 2049  -m state --state NEW  -j ACCEPT
    ...
    for i_end1 in $i_end1_list
    do
    test -n "$i_end1" && $IPTABLES -A Cid7588X794954.0  -s $i_end1   -j ACCEPT 
    done
    for i_end0 in $i_end0_list
    do
    test -n "$i_end0" && $IPTABLES -A Cid7588X794954.0  -s $i_end0   -j ACCEPT 
    done
