...
if [ "$OS" == "RedHat" ]; then
    ...
    do
        ...
        $sudo_cmd apt-get install -o Acquire::Retries="5" -o "Dpkg::Options::=--force-confdef" -o "Dpkg::Options::=--force-confold" -y apt-transport-https curl gnupg 2>$VEC_APT_INSTALL_ERROR_MSG || apt_exit_code=$?
